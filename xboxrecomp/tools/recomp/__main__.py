    ...
    if args.split:
        ...
        if args.manual_functions:
            ...
            for key, pinned_name in pinned.items():
                ...
                # "wrap:Name": hand-written Name, but the original body is still
                # generated as Name_orig so the wrapper can call through to it.
                if pinned_name.startswith("wrap:"):
                    pinned_name = pinned_name[5:]
                    wrapped.add(addr)
