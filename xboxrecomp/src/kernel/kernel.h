...
/* 64 MB (retail) unless the title asks for more with xbox_SetContigSize
 * before xbox_MemoryLayoutInit -- a 128 MB development kit's worth. */
extern uint32_t g_xbox_contig_size;
void xbox_SetContigSize(uint32_t bytes);
#define XBOX_CONTIG_SIZE (g_xbox_contig_size)
